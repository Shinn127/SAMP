...
class TEMOS(BaseModel):
    ...
    def allsplit_step(self, split: str, batch, batch_idx):
        ...
        # Compute the losses
        # NOTE:
        # torchmetrics>=0.7 wraps Metric.update() and returns None.
        # We need the real loss tensor for Lightning automatic optimization,
        # so call the class method directly to bypass the wrapper.
        loss_metric = self.losses[split]
        loss = type(loss_metric).update(loss_metric,
    ...
    def allsplit_epoch_end(self, split: str, outputs=None):
        dico = {}
